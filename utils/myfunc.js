...
exports.serialize = (sock, msg) => {
    ...
    try{
        ...
        msg.quotedMsg.fromMe = msg.quotedMsg.sender === sock.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
...
exports.resize = async (buffer, uk1, uk2) => {
